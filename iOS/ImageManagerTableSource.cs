...
{
	public class ImageManagerTableSource : UITableViewSource
	{
		List<FileListAttributes> tableItems;
		string cellIdentifier = "ImageManagerTableCell";
		public ImageManagerTableSource(List<FileListAttributes> items)
		{
		...
		{
			var cell = tableView.DequeueReusableCell(cellIdentifier) as ImageManagerTableCell;
			if (cell == null)
				cell = new UITableViewCell(UITableViewCellStyle.Default, cellIdentifier) as ImageManagerTableCell;
